...
import { ESeverity, SeverityIcon } from '../../enums/severity.enum';
...
export class SnackBarComponent {
  ...
  constructor(
    ...
    this.severityClass = `alert-${data.severity.toLowerCase()}`;
    this.icon = SeverityIcon[data.severity];
  }

  ngOnInit() {
    this.severityClass = `alert-${this.data.severity}`;
    this.icon = SeverityIcon[this.data.severity];
  }
